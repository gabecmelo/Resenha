 ...
 * resposta melhor que um critério inventado (`CCT-30`).
 */
export function CartasEncerrada({ projecao, enviar, aoSair }: PropsDaTela) {
  ...
  const campeoes = cartas.campeoes ?? []
  ...
  return (
    <Shell
      ...
      faixa={
        ...
        >
          {campeoes.length === 0
            ? 'A partida acabou sem ninguém marcar ponto.'
            : souCampeao
              ? 'Você levou a partida. A mesa que aguente.'
        ...
        <div className="flex flex-col gap-5">
          ...
          <section className="rounded-papel border border-linha bg-superficie p-4">
            <div className="flex items-baseline justify-between gap-2">
              ...
              <p className="text-rotulo text-texto-3 uppercase">
                {cartas.rodada} {cartas.rodada === 1 ? 'rodada' : 'rodadas'}
              </p>
            </div>
